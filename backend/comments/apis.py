...
class CommentListAPI(APIView):
    """
    Endpoint responsible for returning comments list for given article.
    Comments are grouped by threads, ordered properly.
...
class CommentDetailAPI(APIView):
    """
    Endpoint responsible for returning detailed comment data. Accepted request: GET
    """
...
class CommentCreateAPI(APIView):
    """
    Endpoint responsible for creating comment related to given article.
    Operates on two urls - second being a reply for already existing comment.
...
class CommentUpdateAPI(APIView):
    """
    Endpoint responsible for comment instance update. Accepted request: PATCH
    """
...
class CommentDeleteAPI(APIView):
    """
    Endpoint responsible for comment instance deletion. Accepted request: DELETE
    """
