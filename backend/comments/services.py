...
def comment_freeze(*, comment: Comment):
    """Marks comment as no longer updatable, formatting contents but not deleting object for coherence
    and backtracking measures"""
...
def comment_create(*,
    ...
    """Service responsible for comment instance creation, along with all adjacent logical actions"""
...
def comment_update(*,
    ...
    """Service responsible for comment instance update, along with potential related data changes"""
...
def comment_delete(*, user: User, comment: Comment, article: Article) -> None:
    """Service responsible for comment instance deletion/freeze, depending on business logic conditions"""
